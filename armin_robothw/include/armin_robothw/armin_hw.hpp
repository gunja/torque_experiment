...
#include "armin_robothw/armin_hardware.hpp"
#include "armin_robothw/ecn.h"
#include "armin_robothw/festo_over_ec.h"
#include "armin_robothw/ekxx.h"
#include "armin_robothw/elxx.h"
#include "armin_robothw/HowDoYouDo.h"
#include "armin_robothw/GetErrorsList.h"
#include "armin_robothw/ExecuteCommand.h"
#include "armin_robothw/el41xx.h"
...
class ArminHW : public hardware_interface::RobotHW 
{
    ...
    ELXX * el2819;
    EL41XX * el4102;
    int festo_controllers_found; // should be properly initialized after adding Beckhoff on the network
  ...
  private:
    ...
    void loadPositionsFromFile(FestoController *);
    void storeHomePositions(FestoController *);
    void earlyReactOnNewData();
  ...
  public:
    ...
    //callback interface for pneumatic analog port
    void pneumaticAnalogPortCh1Callback(const std_msgs::Int16::ConstPtr&);
    ...
    bool clearErrorsOnInit();

    bool HDYDCallback(armin_robothw::HowDoYouDo::Request &req, armin_robothw::HowDoYouDo::Response &resp);
    bool GLoECallback(armin_robothw::GetErrorsList::Request &req, armin_robothw::GetErrorsList::Response &resp);
    bool ExeComCallback(armin_robothw::ExecuteCommand::Request &req, armin_robothw::ExecuteCommand::Response &resp);
