...
def main():
    ...
    pose.position.x = -0.445136477602
    pose.position.y = 0.828499355842
    pose.position.z = 0.580140716449

    pose.orientation.x = -0.700439888196
    pose.orientation.y = -6.35380324392e-05
    pose.orientation.z = 0.000239908920727
    pose.orientation.w = 0.713711357224
