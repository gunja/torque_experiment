...
def main():
    ...
    pose.position.x = -0.155174376436
    pose.position.y = 0.871546541262
    pose.position.z = 0.547283275121

    pose.orientation.x = -0.705369008275
    pose.orientation.y = 0.109858255958
    pose.orientation.z = -0.118804782831
    pose.orientation.w = 0.690124010117
